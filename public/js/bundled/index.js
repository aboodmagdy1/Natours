...
})({"722o8":[function(require,module,exports) {
...
},{"d216c064b1358f3c":"dIGt4","1c481c3976db4963":"7GlkT","2f28b594354cc1cb":"gOMir","a3bfb0e7fddbeec2":"fOR0B","656cad299046f403":"4OXGm","c6df1fafd470117e":"f9Wim","76575fb1941d955e":"5ZsyC"}],"3cPf4":[function(require,module,exports) {
"use strict";
...
const logout = async ()=>{
    try {
        ...
        (0, _alert.showAlert)("error", "Error logging out! trye again");
    }
};
...
const updateSettings = async (data, type)=>{
    try {
        ...
        if (result.data.status === "success") (0, _alert.showAlert)("success", `${type.toUpperCase()} updated successfully`);
    } catch (err) {
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alert = require("./alert");
const stripe = Stripe("pk_test_51NdXkAIWcciXmlGW03WBuNeoPTsvPRFTdXifbn16s1KG8LD9XhHLGhlIKDHT6AxlR2IGP3GPiFubD8qTrvaxmr0i004opqhCl2");
...
},{"axios":"jo6P5","./alert":"kxdiQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["722o8","f2QDv"], "f2QDv", "parcelRequire135a")
